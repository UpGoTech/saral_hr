...
function init_mark_attendance($main) {
    ...
    function hideTableLoading() { tableLoading.style.display="none"; tableEl.style.display="table"; }
        ...
        frappe.call({
            ...
            callback: function (r) {
                ...
                if (r.message && r.message.success) {
                    var saved = r.message.saved_count || changedData.length, errors = r.message.errors;
                    frappe.show_alert({
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () { document.querySelector(".ma-table-scroll").scrollTop = scrollPos; }, 100);
                    }, 300);
                } else {
