frappe.query_reports["Professional Tax Register"] = {
    ...
    onload(report) {
        report.page.set_primary_action(__("Print"), function () {
            ...
            frappe.call({
                method: "saral_hr.saral_hr.report.professional_tax_register.professional_tax_register.print_report",
                args: {
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        // Suppress pt_rate on total row, bold everything else
        if (data.bold && fn === "pt_rate") return "";
