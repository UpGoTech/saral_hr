frappe.query_reports["Salary Summary"] = {
    ...
    onload(report) {
        report.page.set_primary_action(__("Print"), function () {
            ...
            frappe.call({
                method: "saral_hr.saral_hr.report.salary_summary.salary_summary.print_report",
                args: {
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        if (data._row_type === "grand_total") return bold(value);

        // Hide empty amount cells on component rows
        if ((fn === "amount" || fn === "ded_amount" || fn === "oth_amount")
