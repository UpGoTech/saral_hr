frappe.query_reports["Retention Deposit Register"] = {
    ...
    onload(report) {
        report.page.set_primary_action(__("Print"), function () {
            ...
            frappe.call({
                method: "saral_hr.saral_hr.report.retention_deposit_register.retention_deposit_register.print_report",
                args: {
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        // On total row suppress date columns, bold numeric ones
        if (data.bold) {
            const skip = ["date_of_joining", "ded_upto"];
