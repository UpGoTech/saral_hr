frappe.query_reports["Provident Fund Register"] = {
    ...
    onload(report) {
        report.page.set_primary_action(__("Print"), function () {
            ...
            frappe.call({
                method: "saral_hr.saral_hr.report.provident_fund_register.provident_fund_register.print_report",
                args: {
    ...
    formatter(value, row, column, data, default_formatter) {
        ...
        // On total row suppress identity/date columns, bold numeric ones
        if (data.bold) {
            const skip = ["pf_no", "uan_no", "days", "absent", "date_of_joining", "date_of_birth"];
